...
export default {
    ...
    analyticsData: [
      { 'orderType': 'Total Kcal', 'counts': 124, color: 'primary' },
      { 'orderType': 'Protien', 'counts': 3, color: 'warning' },
      { 'orderType': 'Carbs ', 'counts': 23, color: 'danger' },
      { 'orderType': 'Fats ', 'counts': 1, color: 'success' },
    ],
    series: [100, Math.round(((4*3)/124)*100), Math.round(((4*23)/124)*100),Math.round(((9*1)/124)*100)],
    chartOptions: {
      labels: ['Total Kcal', 'Protien', 'Carbs', 'Fats'],
      plotOptions: {
        radialBar: {
          size: 165,
          offsetY: -25,
