<!-- =========================================================================================
    File Name:  Program Opted
    Description: These Details are added by Admin, this page is for add edit and delete Program Opted
     ========================================================================================== -->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getInterests(){
                firebase.firestore().collection('program-opted').orderBy('createdAt', 'desc').get().then((querySnapshot) => {
                    this.Interests = []
            ...
            saveInterest(){
                this.$validator.validateAll().then(result => {
                    if (result) {
                        ...
                        firebase.firestore().collection("program-opted").add(
                            memberPayLoad
                        )
                            .then(() => {
                                    this.getInterests();
            ...
            deleteInterest(uid, title) {
                ...
                firebase.firestore().collection('program-opted')
                    .doc(uid).delete()
                    .then(() => {
                        this.getInterests()
            ...
            editInterest(uid){
                firebase.firestore().collection('program-opted').doc(uid).get().then((doc) => {
                    let value = doc.data();
            ...
            updateInterest(){
                this.$validator.validateAll().then(result => {
                    if (result) {
                        ...
                        this.loadContent()
                        firebase.firestore().collection('program-opted').doc(this.interestUID).get()
                            .then(snap => {
