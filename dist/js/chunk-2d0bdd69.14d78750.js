(window["webpackJsonp"]=window["webpackJsonp"]||[]).push([["chunk-2d0bdd69"],{"2e66":function(e,t,r){"use strict";r.r(t),r.d(t,"registerStorage",(function(){return It}));var n=r("c23d"),o=r.n(n),i=r("9ab4"),a="firebasestorage.googleapis.com",s="storageBucket",u=12e4,c=6e4,l=-9007199254740991,h=function(){function e(e,t){this.code_=f(e),this.message_="Firebase Storage: "+t,this.serverResponse_=null,this.name_="FirebaseError"}return e.prototype.codeProp=function(){return this.code},e.prototype.codeEquals=function(e){return f(e)===this.codeProp()},e.prototype.serverResponseProp=function(){return this.serverResponse_},e.prototype.setServerResponseProp=function(e){this.serverResponse_=e},Object.defineProperty(e.prototype,"name",{get:function(){return this.name_},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"code",{get:function(){return this.code_},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"message",{get:function(){return this.message_},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"serverResponse",{get:function(){return this.serverResponse_},enumerable:!0,configurable:!0}),e}(),p={UNKNOWN:"unknown",OBJECT_NOT_FOUND:"object-not-found",BUCKET_NOT_FOUND:"bucket-not-found",PROJECT_NOT_FOUND:"project-not-found",QUOTA_EXCEEDED:"quota-exceeded",UNAUTHENTICATED:"unauthenticated",UNAUTHORIZED:"unauthorized",RETRY_LIMIT_EXCEEDED:"retry-limit-exceeded",INVALID_CHECKSUM:"invalid-checksum",CANCELED:"canceled",INVALID_EVENT_NAME:"invalid-event-name",INVALID_URL:"invalid-url",INVALID_DEFAULT_BUCKET:"invalid-default-bucket",NO_DEFAULT_BUCKET:"no-default-bucket",CANNOT_SLICE_BLOB:"cannot-slice-blob",SERVER_FILE_WRONG_SIZE:"server-file-wrong-size",NO_DOWNLOAD_URL:"no-download-url",INVALID_ARGUMENT:"invalid-argument",INVALID_ARGUMENT_COUNT:"invalid-argument-count",APP_DELETED:"app-deleted",INVALID_ROOT_OPERATION:"invalid-root-operation",INVALID_FORMAT:"invalid-format",INTERNAL_ERROR:"internal-error"};function f(e){return"storage/"+e}function d(){var e="An unknown error occurred, please check the error payload for server response.";return new h(p.UNKNOWN,e)}function _(e){return new h(p.OBJECT_NOT_FOUND,"Object '"+e+"' does not exist.")}function v(e){return new h(p.QUOTA_EXCEEDED,"Quota for bucket '"+e+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function m(){var e="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new h(p.UNAUTHENTICATED,e)}function b(e){return new h(p.UNAUTHORIZED,"User does not have permission to access '"+e+"'.")}function g(){return new h(p.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function y(){return new h(p.CANCELED,"User canceled the upload/download.")}function R(e){return new h(p.INVALID_URL,"Invalid URL '"+e+"'.")}function w(e){return new h(p.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+e+"'.")}function E(){return new h(p.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+s+"' property when initializing the app?")}function T(){return new h(p.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function U(){return new h(p.SERVER_FILE_WRONG_SIZE,"Server recorded incorrect upload file size, please retry the upload.")}function A(){return new h(p.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function N(e,t,r){return new h(p.INVALID_ARGUMENT,"Invalid argument in `"+t+"` at index "+e+": "+r)}function k(e,t,r,n){var o,i;return e===t?(o=e,i=1===e?"argument":"arguments"):(o="between "+e+" and "+t,i="arguments"),new h(p.INVALID_ARGUMENT_COUNT,"Invalid argument count in `"+r+"`: Expected "+o+" "+i+", received "+n+".")}function O(){return new h(p.APP_DELETED,"The Firebase app was deleted.")}function C(e){return new h(p.INVALID_ROOT_OPERATION,"The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function S(e,t){return new h(p.INVALID_FORMAT,"String does not match format '"+e+"': "+t)}function x(e){throw new h(p.INTERNAL_ERROR,"Internal error: "+e)}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function me(e){return"https://"+a+"/v0"+e}function be(e){var t=encodeURIComponent,r="?";for(var n in e)if(e.hasOwnProperty(n)){var o=t(n)+"="+t(e[n]);r=r+o+"&"}return r=r.slice(0,-1),r}
/**
 * @license
 * Copyright 2017 Google Inc.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ce="maxResults",Se=1e3,xe="pageToken",Pe="prefixes",Ie="items";function Le(e,t){var r={prefixes:[],items:[],nextPageToken:t["nextPageToken"]},n=e.bucket();if(null===n)throw E();if(t[Pe])for(var o=0,i=t[Pe];o<i.length;o++){var a=i[o],s=a.replace(/\/$/,""),u=e.makeStorageReference(new pe(n,s));r.prefixes.push(u)}if(t[Ie])for(var c=0,l=t[Ie];c<l.length;c++){var h=l[c];u=e.makeStorageReference(new pe(n,h["name"]));r.items.push(u)}return r}function De(e,t){var r=fe(t);if(null===r)return null;var n=r;return Le(e,n)}function Me(e){if(!$(e)||!e)throw"Expected ListOptions object.";for(var t in e)if(t===Ce){if(!re(e[Ce])||e[Ce]<=0)throw"Expected maxResults to be a positive number.";if(e[Ce]>1e3)throw"Expected maxResults to be less than or equal to "+Se+"."}else{if(t!==xe)throw"Unknown option: "+t;if(e[xe]&&!te(e[xe]))throw"Expected pageToken to be string."}}var We=function(){function e(e,t,r,n){this.url=e,this.method=t,this.handler=r,this.timeout=n,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}return e}();
/**
 * @license
 * Copyright 2017 Google Inc.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Be(e){if(!e)throw d()}function Ge(e,t){function r(r,n){var o=Ae(e,n,t);return Be(null!==o),o}return r}function je(e){function t(t,r){var n=De(e,r);return Be(null!==n),n}return t}function qe(e,t){function r(r,n){var o=Ae(e,n,t);return Be(null!==o),Ne(o,n)}return r}function Fe(e){function t(t,r){var n;return n=401===t.getStatus()?m():402===t.getStatus()?v(e.bucket):403===t.getStatus()?b(e.path):r,n.setServerResponseProp(r.serverResponseProp()),n}return t}function He(e){var t=Fe(e);function r(r,n){var o=t(r,n);return 404===r.getStatus()&&(o=_(e.path)),o.setServerResponseProp(n.serverResponseProp()),o}return r}function ze(e,t,r){var n=t.fullServerUrl(),o=me(n),i="GET",a=e.maxOperationRetryTime(),s=new We(o,i,Ge(e,r),a);return s.errorHandler=He(t),s}function Xe(e,t,r,n,o){var i={};t.isRoot?i["prefix"]="":i["prefix"]=t.path+"/",r&&r.length>0&&(i["delimiter"]=r),n&&(i["pageToken"]=n),o&&(i["maxResults"]=o);var a=t.bucketOnlyServerUrl(),s=me(a),u="GET",c=e.maxOperationRetryTime(),l=new We(s,u,je(e),c);return l.urlParams=i,l.errorHandler=Fe(t),l}function Ve(e,t,r){var n=t.fullServerUrl(),o=me(n),i="GET",a=e.maxOperationRetryTime(),s=new We(o,i,qe(e,r),a);return s.errorHandler=He(t),s}function Ke(e,t,r,n){var o=t.fullServerUrl(),i=me(o),a="PATCH",s=ke(r,n),u={"Content-Type":"application/json; charset=utf-8"},c=e.maxOperationRetryTime(),l=new We(i,a,Ge(e,n),c);return l.headers=u,l.body=s,l.errorHandler=He(t),l}function Ze(e,t){var r=t.fullServerUrl(),n=me(r),o="DELETE",i=e.maxOperationRetryTime();function a(e,t){}var s=new We(n,o,a,i);return s.successCodes=[200,204],s.errorHandler=He(t),s}function Je(e,t){return e&&e["contentType"]||t&&t.type()||"application/octet-stream"}function Qe(e,t,r){var n=Object.assign({},r);return n["fullPath"]=e.path,n["size"]=t.size(),n["contentType"]||(n["contentType"]=Je(null,t)),n}function $e(e,t,r,n,o){var i=t.bucketOnlyServerUrl(),a={"X-Goog-Upload-Protocol":"multipart"};function s(){for(var e="",t=0;t<2;t++)e+=Math.random().toString().slice(2);return e}var u=s();a["Content-Type"]="multipart/related; boundary="+u;var c=Qe(t,n,o),l=ke(c,r),h="--"+u+"\r\nContent-Type: application/json; charset=utf-8\r\n\r\n"+l+"\r\n--"+u+"\r\nContent-Type: "+c["contentType"]+"\r\n\r\n",p="\r\n--"+u+"--",f=he.getBlob(h,n,p);if(null===f)throw T();var d={name:c["fullPath"]},_=me(i),v="POST",m=e.maxUploadRetryTime(),b=new We(_,v,Ge(e,r),m);return b.urlParams=d,b.headers=a,b.body=f.uploadData(),b.errorHandler=Fe(t),b}var Ye=function(){function e(e,t,r,n){this.current=e,this.total=t,this.finalized=!!r,this.metadata=n||null}return e}();function et(e,t){var r=null;try{r=e.getResponseHeader("X-Goog-Upload-Status")}catch(o){Be(!1)}var n=t||["active"];return Be(!!r&&-1!==n.indexOf(r)),r}function tt(e,t,r,n,o){var i=t.bucketOnlyServerUrl(),a=Qe(t,n,o),s={name:a["fullPath"]},u=me(i),c="POST",l={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":n.size(),"X-Goog-Upload-Header-Content-Type":a["contentType"],"Content-Type":"application/json; charset=utf-8"},h=ke(a,r),p=e.maxUploadRetryTime();function f(e){var t;et(e);try{t=e.getResponseHeader("X-Goog-Upload-URL")}catch(r){Be(!1)}return Be(te(t)),t}var d=new We(u,c,f,p);return d.urlParams=s,d.headers=l,d.body=h,d.errorHandler=Fe(t),d}function rt(e,t,r,n){var o={"X-Goog-Upload-Command":"query"};function i(e){var t=et(e,["active","final"]),r=null;try{r=e.getResponseHeader("X-Goog-Upload-Size-Received")}catch(i){Be(!1)}r||Be(!1);var o=Number(r);return Be(!isNaN(o)),new Ye(o,n.size(),"final"===t)}var a="POST",s=e.maxUploadRetryTime(),u=new We(r,a,i,s);return u.headers=o,u.errorHandler=Fe(t),u}var nt=262144;function ot(e,t,r,n,o,i,a,s){var u=new Ye(0,0);if(a?(u.current=a.current,u.total=a.total):(u.current=0,u.total=n.size()),n.size()!==u.total)throw U();var c=u.total-u.current,l=c;o>0&&(l=Math.min(l,o));var h=u.current,p=h+l,f=l===c?"upload, finalize":"upload",d={"X-Goog-Upload-Command":f,"X-Goog-Upload-Offset":u.current},_=n.slice(h,p);if(null===_)throw T();function v(e,r){var o,a=et(e,["active","final"]),s=u.current+l,c=n.size();return o="final"===a?Ge(t,i)(e,r):null,new Ye(s,c,"final"===a,o)}var m="POST",b=t.maxUploadRetryTime(),g=new We(r,m,v,b);return g.headers=d,g.body=_.uploadData(),g.progressCallback=s||null,g.errorHandler=Fe(e),g}
/**
 * @license
 * Copyright 2017 Google Inc.
 *
 ...
 * limitations under the License.
 */
function st(e,t,r){for(var n=t.length,o=t.length,i=0;i<t.length;i++)if(t[i].optional){n=i;break}var a=n<=r.length&&r.length<=o;if(!a)throw k(n,o,e,r.length);for(i=0;i<r.length;i++)try{t[i].validator(r[i])}catch(s){throw s instanceof Error?N(i,e,s.message):N(i,e,s)}}var ut=function(){function e(e,t){var r=this;this.validator=function(t){r.optional&&!J(t)||e(t)},this.optional=!!t}return e}();function ct(e,t){return function(r){e(r),t(r)}}function lt(e,t){function r(e){if(!te(e))throw"Expected string."}var n;return n=e?ct(r,e):r,new ut(n,t)}function ht(){function e(e){var t=e instanceof Uint8Array||e instanceof ArrayBuffer||ie()&&e instanceof Blob;if(!t)throw"Expected Blob or File."}return new ut(e)}function pt(e){return new ut(Oe,e)}function ft(e){return new ut(Me,e)}function dt(){function e(e){var t=ne(e)&&e>=0;if(!t)throw"Expected a number 0 or greater."}return new ut(e)}function _t(e,t){function r(t){var r=null===t||Z(t)&&t instanceof Object;if(!r)throw"Expected an Object.";void 0!==e&&null!==e&&e(t)}return new ut(r,t)}function vt(e){function t(e){var t=null===e||Q(e);if(!t)throw"Expected a Function."}return new ut(t,e)}
/**
 * @license
 * Copyright 2017 Google Inc.
 *
 ...
 * limitations under the License.
 */
function Et(e,t,r){var n=1,o=null,i=!1,a=0;function s(){return 2===a}var u=!1;function c(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];u||(u=!0,t.apply(null,e))}function l(t){o=setTimeout((function(){o=null,e(h,s())}),t)}function h(e){for(var t=[],r=1;r<arguments.length;r++)t[r-1]=arguments[r];if(!u)if(e)c.call.apply(c,[null,e].concat(t));else{var o,h=s()||i;if(h)c.call.apply(c,[null,e].concat(t));else n<64&&(n*=2),1===a?(a=2,o=0):o=1e3*(n+Math.random()),l(o)}}var p=!1;function f(e){p||(p=!0,u||(null!==o?(e||(a=2),clearTimeout(o),l(0)):e||(a=1)))}return l(0),setTimeout((function(){i=!0,f(!0)}),r),f}function Tt(e){e(!1)}
/**
 * @license
 * Copyright 2017 Google Inc.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ut=function(){function e(e,t,r,n,o,i,a,s,u,c,l){var h=this;this.pendingXhr_=null,this.backoffId_=null,this.resolve_=null,this.reject_=null,this.canceled_=!1,this.appDelete_=!1,this.url_=e,this.method_=t,this.headers_=r,this.body_=n,this.successCodes_=o.slice(),this.additionalRetryCodes_=i.slice(),this.callback_=a,this.errorCallback_=s,this.progressCallback_=c,this.timeout_=u,this.pool_=l,this.promise_=new Promise((function(e,t){h.resolve_=e,h.reject_=t,h.start_()}))}return e.prototype.start_=function(){var e=this;function t(t,r){if(r)t(!1,new At(!1,null,!0));else{var n=e.pool_.createXhrIo();e.pendingXhr_=n,null!==e.progressCallback_&&n.addUploadProgressListener(o),n.send(e.url_,e.method_,e.body_,e.headers_).then((function(r){null!==e.progressCallback_&&r.removeUploadProgressListener(o),e.pendingXhr_=null,r=r;var n=r.getErrorCode()===H.NO_ERROR,i=r.getStatus();if(n&&!e.isRetryStatusCode_(i)){var a=-1!==e.successCodes_.indexOf(i);t(!0,new At(a,r))}else{var s=r.getErrorCode()===H.ABORT;t(!1,new At(!1,null,s))}}))}function o(t){var r=t.loaded,n=t.lengthComputable?t.total:-1;null!==e.progressCallback_&&e.progressCallback_(r,n)}}function r(t,r){var n=e.resolve_,o=e.reject_,i=r.xhr;if(r.wasSuccessCode)try{var a=e.callback_(i,i.getResponseText());J(a)?n(a):n()}catch(u){o(u)}else if(null!==i){var s=d();s.setServerResponseProp(i.getResponseText()),e.errorCallback_?o(e.errorCallback_(i,s)):o(s)}else if(r.canceled){s=e.appDelete_?O():y();o(s)}else{s=g();o(s)}}this.canceled_?r(!1,new At(!1,null,!0)):this.backoffId_=Et(t,r,this.timeout_)},e.prototype.getPromise=function(){return this.promise_},e.prototype.cancel=function(e){this.canceled_=!0,this.appDelete_=e||!1,null!==this.backoffId_&&Tt(this.backoffId_),null!==this.pendingXhr_&&this.pendingXhr_.abort()},e.prototype.isRetryStatusCode_=function(e){var t=e>=500&&e<600,r=[408,429],n=-1!==r.indexOf(e),o=-1!==this.additionalRetryCodes_.indexOf(e);return t||n||o},e}(),At=function(){function e(e,t,r){this.wasSuccessCode=e,this.xhr=t,this.canceled=!!r}return e}();function Nt(e,t){null!==t&&t.length>0&&(e["Authorization"]="Firebase "+t)}function kt(e){var t="undefined"!==typeof o.a?o.a.SDK_VERSION:"AppManager";e["X-Firebase-Storage-Version"]="webjs/"+t}function Ot(e,t,r){var n=be(e.urlParams),o=e.url+n,i=Object.assign({},e.headers);return Nt(i,t),kt(i),new Ut(o,e.method,i,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,r)}
/**
 * @license
 * Copyright 2017 Google Inc.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ct=function(){function e(e,t,r){function n(e,t){return new gt(e,t)}if(this.bucket_=null,this.authWrapper_=new wt(e,n,Ot,this,t),this.app_=e,null!=r)this.bucket_=pe.makeFromBucketSpec(r);else{var o=this.authWrapper_.bucket();null!=o&&(this.bucket_=new pe(o,""))}this.internals_=new St(this)}return e.prototype.ref=function(e){function t(e){if("string"!==typeof e)throw"Path is not a string.";if(/^[A-Za-z]+:\/\//.test(e))throw"Expected child path but got a URL, use refFromURL instead."}if(st("ref",[lt(t,!0)],arguments),null==this.bucket_)throw new Error("No Storage Bucket defined in Firebase Options.");var r=new gt(this.authWrapper_,this.bucket_);return null!=e?r.child(e):r},e.prototype.refFromURL=function(e){function t(e){if("string"!==typeof e)throw"Path is not a string.";if(!/^[A-Za-z]+:\/\//.test(e))throw"Expected full URL but got a child path, use ref instead.";try{pe.makeFromUrl(e)}catch(t){throw"Expected valid full URL but got an invalid one."}}return st("refFromURL",[lt(t,!1)],arguments),new gt(this.authWrapper_,e)},Object.defineProperty(e.prototype,"maxUploadRetryTime",{get:function(){return this.authWrapper_.maxUploadRetryTime()},enumerable:!0,configurable:!0}),e.prototype.setMaxUploadRetryTime=function(e){st("setMaxUploadRetryTime",[dt()],arguments),this.authWrapper_.setMaxUploadRetryTime(e)},e.prototype.setMaxOperationRetryTime=function(e){st("setMaxOperationRetryTime",[dt()],arguments),this.authWrapper_.setMaxOperationRetryTime(e)},Object.defineProperty(e.prototype,"app",{get:function(){return this.app_},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"INTERNAL",{get:function(){return this.internals_},enumerable:!0,configurable:!0}),e}(),St=function(){function e(e){this.service_=e}return e.prototype.delete=function(){return this.service_.authWrapper_.deleteApp(),Promise.resolve()},e}(),xt="storage";function Pt(e,t,r){return new Ct(e,new se,r)}function It(e){var t={TaskState:V,TaskEvent:z,StringFormat:P,Storage:Ct,Reference:gt};e.INTERNAL.registerService(xt,Pt,t,void 0,!0)}It(o.a)}}]);
//# sourceMappingURL=chunk-2d0bdd69.14d78750.js.map